"""
Django settings for hackerhsack_website project.
...
PROJECT_DIR = os.path.join(BASE_DIR, "hackerhsack_website")
...
ROOT_URLCONF = 'hackerhsack_website.urls'
...
WSGI_APPLICATION = 'hackerhsack_website.wsgi.application'
